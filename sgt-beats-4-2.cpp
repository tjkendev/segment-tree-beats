...
class SegmentTree {
  ...
  // a_i が最大値となる中で、最大値となるペア(a_i, b_i)
  Pair max_p[4*N];
  // a_i が最大値未満となる中で、最大値となるペア(a_i, b_i)
  Pair nmax_p[4*N];
